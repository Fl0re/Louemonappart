...
<section id="creer">
 <h2> Annonce</h2>
    <form action="serviceannonce" method="post">
      ...
      <option value="pontoise">Pontoise (95)</option>
        ...
        <label>tarif</label> <input type="text" name="tarif"/><br>
        <label>Type de propriété</label>
        <select name="propriete">
            <option value="Maison">Maison </option>
            <option value="Appt">Appt </option>
            <option value="Chalet">Maison </option>
        </select><br>
        ...
        <label>superficie</label> <input type="text" name="superficie"/><br>
        <label>dispo_debut</label> <input type="date" name="dispo_debut"/><br>
        <label>dispo_fin</label> <input type="date" name="dispo_fin"/><br>
    ...
    if(!empty($_SESSION['user'])){
       echo" <input  id='valide'type='submit' value='valider' />
    </form>";}
if(empty($_SESSION['user'])){
   echo" <h1> MERCI DE TE CONNECTER </h1>";
    }
    ?>
